export const resources = {
  ca: {
    translation: {
      ...
      chat: {
        title: "Guia del viatge",
        greeting: "Hola! Sóc el teu guia per aquest viatge. Pregunta'm el que vulguis sobre els llocs, la cultura o l'itinerari.",
  ...
  en: {
    translation: {
      ...
      chat: {
        title: "Trip guide",
        greeting: "Hi! I'm your guide for this trip. Ask me anything about the places, culture or the itinerary.",
  ...
  es: {
    translation: {
      ...
      chat: {
        title: "Guía del viaje",
        greeting: "¡Hola! Soy tu guía para este viaje. Pregúntame lo que quieras sobre los sitios, la cultura o el itinerario.",
  ...
  ja: {
    translation: {
      ...
      chat: {
        title: "旅の案内人",
        greeting: "こんにちは！この旅のガイドです。場所や文化、旅程について何でも聞いてください。",
        placeholder: "質問を入力…",
        thinking: "考え中…",
