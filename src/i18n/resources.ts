export const resources = {
  ca: {
    translation: {
      ...
      admin: {
        badge: "Admin",
        syncDisabled: "Firebase no configurat: els canvis d'admin encara no es desen enlloc.",
        concept: "Concepte",
  ...
  en: {
    translation: {
      ...
      admin: {
        badge: "Admin",
        syncDisabled: "Firebase not configured yet: admin changes aren't saved anywhere yet.",
        concept: "Concept",
  ...
  es: {
    translation: {
      ...
      admin: {
        badge: "Admin",
        syncDisabled: "Firebase sin configurar: los cambios de admin todavía no se guardan en ningún sitio.",
        concept: "Concepto",
  ...
  ja: {
    translation: {
      ...
      admin: {
        badge: "管理者",
        syncDisabled: "Firebase未設定：管理者の変更内容はまだ保存されません。",
        concept: "項目",
        costTotal: "合計金額",
        costPerPerson: "1人あたり",
        link: "リンク",
